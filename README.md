...
2. For Distribution and Remoting it offers Actors 
(Actor Model)[http://arxiv.org/pdf/1008.1459.pdf],
(Actor Model)[http://publications.csail.mit.edu/lcs/pubs/pdf/MIT-LCS-TR-194.pdf].  (Scale Out)
